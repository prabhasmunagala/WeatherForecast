function getWeather() {
    ...
    const apiKey = "7f97ea32d589a03063919f7ec3f1ea73";
    const apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=70e062d8734df397a31610a772dbea9a`;
